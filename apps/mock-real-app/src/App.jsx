  ...
  return (
    <div className="app">
      <div className="dialogue">
        <h1>🚀 Mock Real App</h1>
        <p>
          This is the <strong>REAL APPLICATION</strong> - a production-ready frontend 
          that validates the AWS infrastructure by testing connectivity to the backend API.
        </p>

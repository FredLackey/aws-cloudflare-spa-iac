...
# For iac-app-cloudfront package
...
# Configuration for iac-app-cloudfront package
BUCKET_NAME="tfstate-yourapp-cloudfront-sbx"
REGION="us-east-1"
DYNAMODB_TABLE="tfstate-yourapp-cloudfront-sbx"

# AWS Profile handling
AWS_PROFILE="${1:-your-aws-profile-name}"
